...
Usage:
  ...
  agent-skills install --project <path> [--packs core,ai,code,flutter] [--source github:user/repo|https://github.com/user/repo] [--targets codex,claude,gemini] [--version v0.1.0] [--skills all|name,name]
